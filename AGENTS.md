...
- 项目状态：`docs/STATUS.md`
- 文档路由：`docs/INDEX.md`
- 当前阶段：V10.2 Task 193 wuxia Ch200 climb 人工暂停，Task 189/190/191 已完成，Task 192/193/194 任务书已建立；Task 192 xuanhuan Ch200 已完成（Ch200 accepted/current head=`v-5659d486`，run completed_count=200、failed=[]，five-gate PASS，segment audit PASS，T9=0；Task 192.p/q/r/s/t/u/v/w/x/y/z/aa/ab/ac/ad/ae/af/ag/ah/ai/aj/ak/al/am/an/ao/ap/aq/ar/as/at/au/av/aw 已完成）；Task 193.p/q/r/s/t/u/v 已完成；wuxia Ch28 deterministic clean 已完成并初始化 Ch200 target；wuxia 当前 accepted_count=125，Ch125 accepted/current head=`v-f979edd1`，Ch125 段边界审计 five-gate PASS、segment audit PASS、T9=0；run_id=`run-v10-wuxia-5bbfab3a`，final_status=completed @125、failed=[]、total_cost=4.146785；wuxia Ch126+ 起启用 193.v 新匹配逻辑与 193.t actionable 口径；下一步 Ch126→Ch150 后执行 Ch150 审计；尚未完成 wuxia/urban Ch200 长跑；Task 196 优秀度样本集与校准协议已完成（V10.3 提前启动成果：60 章样本集 + 72 条三层标注 + 校准报告；judge 预标单向宽松偏差、现有 ai_tells/fatigue 规则集试点负结果，DONE 见 `tasks/196-excellence-signal-calibration-DONE.md`）；V9 已全量闭环（Task 173-188）
