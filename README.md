...
- [`tasks/192-xuanhuan-ch200-climb-DONE.md`](tasks/192-xuanhuan-ch200-climb-DONE.md) — V10 Task 192：xuanhuan Ch200 climb 完成报告（200/200、five-gate/segment/T9 全 PASS）
- [`docs/reports/192-xuanhuan-ch100-climb.md`](docs/reports/192-xuanhuan-ch100-climb.md) — V10 Task 192：xuanhuan clean Ch100 rebuild 阶段报告
- V10 Task 192.p–192.aw：33 个撞墙修复子任务（全部 DONE），任务书与 DONE 均在 `tasks/` 下，索引见 [`tasks/V10-README.md`](tasks/V10-README.md) 任务表
- [`tasks/193-wuxia-ch200-climb.md`](tasks/193-wuxia-ch200-climb.md) — V10 Task 193：wuxia Ch200 爬坡任务书
- V10 Task 193.p–193.w：8 个撞墙修复与根因治理子任务（全部 DONE），任务书与 DONE 均在 `tasks/` 下，索引见 [`tasks/V10-README.md`](tasks/V10-README.md) 任务表；193.s 诊断报告：[`docs/reports/193s-setting-tracking-root-cause.md`](docs/reports/193s-setting-tracking-root-cause.md)
