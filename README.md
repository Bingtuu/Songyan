...
| V10 | ◐ V10.2 Task 193.q wuxia Ch117 health_low_p1_halt 已冻结 | 跨体裁 Ch200、优秀度信号包、结构升级 spike；Task 189 已冻结 sci-fi Ch200 baseline，Task 190 已完成 Ch100 终点事实源盘点，Task 191 已完成 Ch200 harness 准备，Task 192 xuanhuan Ch200 已完成；Task 193 已到 Ch117 accepted 后触发 P1 hard gate，下一步先修复 193.q |

各阶段事实入口见 [`tasks/V10-README.md`](tasks/V10-README.md)（当前 V10.2 Task 193.q wuxia Ch117 health_low_p1_halt 已冻结）以及 `tasks/V5-README.md`、`tasks/V6-README.md`、`tasks/V7-README.md`、`tasks/V8-README.md`、`tasks/V9-README.md`（均已收尾）；V5-V9 单项任务文档与报告分别归档在 [`archive/v5/`](archive/v5/INDEX.md)、[`archive/v6/`](archive/v6/INDEX.md)、[`archive/v7/`](archive/v7/INDEX.md)、[`archive/v8/`](archive/v8/INDEX.md)、[`archive/v9/`](archive/v9/INDEX.md)。
...
- [`tasks/192.ad-xuanhuan-ch111-health-low-streak-halt-DONE.md`](tasks/192.ad-xuanhuan-ch111-health-low-streak-halt-DONE.md) — V10 Task 192.ad：xuanhuan Ch111 health_low_streak_halt 修复完成报告
- [`tasks/192.ae-xuanhuan-ch120-health-low-p1-halt.md`](tasks/192.ae-xuanhuan-ch120-health-low-p1-halt.md) — V10 Task 192.ae：xuanhuan Ch120 health_low_p1_halt 修复任务书
- [`tasks/192.ae-xuanhuan-ch120-health-low-p1-halt-DONE.md`](tasks/192.ae-xuanhuan-ch120-health-low-p1-halt-DONE.md) — V10 Task 192.ae：xuanhuan Ch120 health_low_p1_halt 修复完成报告
- [`tasks/192.af-xuanhuan-ch129-settlement-json-parse.md`](tasks/192.af-xuanhuan-ch129-settlement-json-parse.md) — V10 Task 192.af：xuanhuan Ch129 SettlementExtractor JSON parse failure 修复任务书
- [`tasks/192.af-xuanhuan-ch129-settlement-json-parse-DONE.md`](tasks/192.af-xuanhuan-ch129-settlement-json-parse-DONE.md) — V10 Task 192.af：xuanhuan Ch129 SettlementExtractor JSON parse failure 修复完成报告
- [`tasks/192.ag-xuanhuan-ch129-segment-audit-critical-orphans.md`](tasks/192.ag-xuanhuan-ch129-segment-audit-critical-orphans.md) — V10 Task 192.ag：xuanhuan Ch129 segment audit critical orphans 修复任务书
...
- [`tasks/192.ai-xuanhuan-ch134-health-low-streak-halt-DONE.md`](tasks/192.ai-xuanhuan-ch134-health-low-streak-halt-DONE.md) — V10 Task 192.ai：xuanhuan Ch134 health_low_streak_halt 修复完成报告
- [`tasks/192.aj-xuanhuan-ch138-health-low-p1-halt.md`](tasks/192.aj-xuanhuan-ch138-health-low-p1-halt.md) — V10 Task 192.aj：xuanhuan Ch138 health_low_p1_halt 修复任务书
- [`tasks/192.aj-xuanhuan-ch138-health-low-p1-halt-DONE.md`](tasks/192.aj-xuanhuan-ch138-health-low-p1-halt-DONE.md) — V10 Task 192.aj：xuanhuan Ch138 health_low_p1_halt 修复完成报告
- [`tasks/192.ak-xuanhuan-ch144-health-low-streak-halt.md`](tasks/192.ak-xuanhuan-ch144-health-low-streak-halt.md) — V10 Task 192.ak：xuanhuan Ch144 health_low_streak_halt 修复任务书
- [`tasks/192.ak-xuanhuan-ch144-health-low-streak-halt-DONE.md`](tasks/192.ak-xuanhuan-ch144-health-low-streak-halt-DONE.md) — V10 Task 192.ak：xuanhuan Ch144 health_low_streak_halt 修复完成报告
- [`tasks/192.al-xuanhuan-ch150-health-low-p1-halt.md`](tasks/192.al-xuanhuan-ch150-health-low-p1-halt.md) — V10 Task 192.al：xuanhuan Ch150 health_low_p1_halt 修复任务书
- [`tasks/192.al-xuanhuan-ch150-health-low-p1-halt-DONE.md`](tasks/192.al-xuanhuan-ch150-health-low-p1-halt-DONE.md) — V10 Task 192.al：xuanhuan Ch150 health_low_p1_halt 修复完成报告
- [`tasks/192.am-xuanhuan-ch150-segment-audit-critical-orphans.md`](tasks/192.am-xuanhuan-ch150-segment-audit-critical-orphans.md) — V10 Task 192.am：xuanhuan Ch150 segment audit critical orphans 修复任务书
- [`tasks/192.am-xuanhuan-ch150-segment-audit-critical-orphans-DONE.md`](tasks/192.am-xuanhuan-ch150-segment-audit-critical-orphans-DONE.md) — V10 Task 192.am：xuanhuan Ch150 segment audit critical orphans 修复完成报告
- [`tasks/192.an-xuanhuan-ch150-five-gate-health-stale-report.md`](tasks/192.an-xuanhuan-ch150-five-gate-health-stale-report.md) — V10 Task 192.an：xuanhuan Ch150 five-gate health stale report 修复任务书
- [`tasks/192.an-xuanhuan-ch150-five-gate-health-stale-report-DONE.md`](tasks/192.an-xuanhuan-ch150-five-gate-health-stale-report-DONE.md) — V10 Task 192.an：xuanhuan Ch150 five-gate health stale report 修复完成报告
- [`tasks/192.ao-xuanhuan-ch156-health-low-streak-halt.md`](tasks/192.ao-xuanhuan-ch156-health-low-streak-halt.md) — V10 Task 192.ao：xuanhuan Ch156 health_low_streak_halt 修复任务书
- [`tasks/192.ao-xuanhuan-ch156-health-low-streak-halt-DONE.md`](tasks/192.ao-xuanhuan-ch156-health-low-streak-halt-DONE.md) — V10 Task 192.ao：xuanhuan Ch156 health_low_streak_halt 修复完成报告
- [`tasks/192.ap-xuanhuan-ch162-health-low-p1-halt.md`](tasks/192.ap-xuanhuan-ch162-health-low-p1-halt.md) — V10 Task 192.ap：xuanhuan Ch162 health_low_p1_halt 修复任务书
- [`tasks/192.ap-xuanhuan-ch162-health-low-p1-halt-DONE.md`](tasks/192.ap-xuanhuan-ch162-health-low-p1-halt-DONE.md) — V10 Task 192.ap：xuanhuan Ch162 health_low_p1_halt 修复完成报告
- [`tasks/192.aq-xuanhuan-ch168-health-low-p1-halt.md`](tasks/192.aq-xuanhuan-ch168-health-low-p1-halt.md) — V10 Task 192.aq：xuanhuan Ch168 health_low_p1_halt 修复任务书
- [`tasks/192.aq-xuanhuan-ch168-health-low-p1-halt-DONE.md`](tasks/192.aq-xuanhuan-ch168-health-low-p1-halt-DONE.md) — V10 Task 192.aq：xuanhuan Ch168 health_low_p1_halt 修复完成报告
- [`tasks/192.ar-xuanhuan-ch175-segment-t9-hard-gates.md`](tasks/192.ar-xuanhuan-ch175-segment-t9-hard-gates.md) — V10 Task 192.ar：xuanhuan Ch175 segment audit + T9 hard gates 修复任务书
- [`tasks/192.ar-xuanhuan-ch175-segment-t9-hard-gates-DONE.md`](tasks/192.ar-xuanhuan-ch175-segment-t9-hard-gates-DONE.md) — V10 Task 192.ar：xuanhuan Ch175 segment audit + T9 hard gates 修复完成报告
- [`tasks/192.as-xuanhuan-ch180-health-low-p1-halt.md`](tasks/192.as-xuanhuan-ch180-health-low-p1-halt.md) — V10 Task 192.as：xuanhuan Ch180 health_low_p1_halt 修复任务书
- [`tasks/192.as-xuanhuan-ch180-health-low-p1-halt-DONE.md`](tasks/192.as-xuanhuan-ch180-health-low-p1-halt-DONE.md) — V10 Task 192.as：xuanhuan Ch180 health_low_p1_halt 修复完成报告
- [`tasks/192.at-xuanhuan-ch186-health-low-p1-halt.md`](tasks/192.at-xuanhuan-ch186-health-low-p1-halt.md) — V10 Task 192.at：xuanhuan Ch186 health_low_p1_halt 修复任务书
- [`tasks/192.at-xuanhuan-ch186-health-low-p1-halt-DONE.md`](tasks/192.at-xuanhuan-ch186-health-low-p1-halt-DONE.md) — V10 Task 192.at：xuanhuan Ch186 health_low_p1_halt 修复完成报告
- [`tasks/192.au-xuanhuan-ch192-health-low-p1-halt.md`](tasks/192.au-xuanhuan-ch192-health-low-p1-halt.md) — V10 Task 192.au：xuanhuan Ch192 health_low_p1_halt 修复任务书
- [`tasks/192.au-xuanhuan-ch192-health-low-p1-halt-DONE.md`](tasks/192.au-xuanhuan-ch192-health-low-p1-halt-DONE.md) — V10 Task 192.au：xuanhuan Ch192 health_low_p1_halt 修复完成报告
- [`tasks/192.av-xuanhuan-ch198-health-low-p1-halt.md`](tasks/192.av-xuanhuan-ch198-health-low-p1-halt.md) — V10 Task 192.av：xuanhuan Ch198 health_low_p1_halt 修复任务书
- [`tasks/192.av-xuanhuan-ch198-health-low-p1-halt-DONE.md`](tasks/192.av-xuanhuan-ch198-health-low-p1-halt-DONE.md) — V10 Task 192.av：xuanhuan Ch198 health_low_p1_halt 修复完成报告
- [`tasks/192.aw-xuanhuan-ch200-five-gate-health-fail.md`](tasks/192.aw-xuanhuan-ch200-five-gate-health-fail.md) — V10 Task 192.aw：xuanhuan Ch200 five-gate health fail 修复任务书
- [`tasks/192.aw-xuanhuan-ch200-five-gate-health-fail-DONE.md`](tasks/192.aw-xuanhuan-ch200-five-gate-health-fail-DONE.md) — V10 Task 192.aw：xuanhuan Ch200 five-gate health fail 修复完成报告
