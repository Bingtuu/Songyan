...
| Task | 结论 | 入口 |
|------|------|------|
| 189 | sci-fi Ch200 baseline/checkpoint 冻结；Ch125/150/175/200 baseline 可重放 | `archive/v10/tasks/189-ch200-baseline-and-checkpoints-DONE.md` |
| 190 | Ch100 终点事实源盘点完成，建立三态准入 | `archive/v10/tasks/190-ch100-terminal-source-inventory-DONE.md` |
| 191 | Ch200 harness 完成，固定 DB/project/run/audit 路径和三态准入 | `archive/v10/tasks/191-ch200-harness-preparation-DONE.md` |

冻结 baseline：`archive/v10/artifacts/189-scifi-ch200-baseline.json`。
...
| Task | 产物 | 结论 |
|------|------|------|
| 196 | `archive/v10/artifacts/196-excellence-sample-set.json` / annotations / calibration report | anchor + spotcheck agent-deep-read 为唯一校准真值，prelabel 仅低置信对照 |
| 197/198 | `archive/v10/artifacts/197-198-excellence-signals-report.json` | 结构同质化与中文 AI 腔 report-only 信号落地 |
| 199 | `archive/v10/artifacts/199-style-card-report.json` | style card 仅为观察画像，不注入 prompt |
| 200 | `archive/v10/artifacts/200-character-voice-anchor-report.json` | 角色声纹锚点保留 unknown 归因，不写回角色档案 |
| 201 | `archive/v10/artifacts/201-judge-bias-report.json` | judge 偏差与对策协议离线落地，不调用 LLM |
| 202 | `archive/v10/artifacts/202-readability-feasibility-report.json` | 真实 PPL defer，可读性 proxy 仅 report-only |
| 203 | `archive/v10/artifacts/203-excellence-integrated-report.json` | 统一优秀度报告双视图落地，不生成硬分、排名或 PASS/FAIL |
