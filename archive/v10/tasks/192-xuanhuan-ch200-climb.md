...
> **状态**: ✅ 已完成：xuanhuan Ch200 accepted 200/200，five-gate @200 PASS，segment audit @200 PASS，T9=0；Ch111/120/125/129/131/134/138/144/150/156/162/168/175/180/186/192/198/200 期间的 hard gate / audit / parse / T9 修复均已闭环；DONE：`tasks/192-xuanhuan-ch200-climb-DONE.md`
> **预计工作量**: 大
...
```powershell
python scripts/run_v10_ch200_climb.py --audit --genre xuanhuan --up-to <125|150|175|200> --baseline archive/v10/artifacts/189-scifi-ch200-baseline.json
```
...
python scripts/run_v10_ch200_climb.py --audit --genre xuanhuan --up-to <checkpoint> --baseline archive/v10/artifacts/189-scifi-ch200-baseline.json --dry-run --format json
git diff --check
```
