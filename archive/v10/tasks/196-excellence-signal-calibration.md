...
- [ ] 样本清单落盘 `archive/v10/artifacts/196-excellence-sample-set.json`：双库各 30 章（每 25 章弧段抽 3-4 章，8 段共 30），含 chapter、version_id、sample_layer、抽样 seed。
- [ ] 标注记录 `archive/v10/artifacts/196-excellence-annotations.json`：60 章全量标注（schema 见下），agent 精读锚点 12 章（好坏两极各 6）+ LLM 预标 48 章 + agent 深读抽检 12 章复核预标。
...
| 样本清单 | `archive/v10/artifacts/196-excellence-sample-set.json`（版本管理，对齐 189 baseline 先例） |
| 标注记录 | `archive/v10/artifacts/196-excellence-annotations.json`（版本管理） |
...
- [ ] `archive/v10/artifacts/196-excellence-sample-set.json` 落盘：双库各 30 章、seed 可复现、弧段全覆盖。
- [ ] `archive/v10/artifacts/196-excellence-annotations.json` 落盘：60 章全量标注，三层 provenance 完整，锚点/抽检含证据引用。
...
- `archive/v10/artifacts/189-scifi-ch200-baseline.json` — sci-fi 冻结库与 baseline
- `tasks/192-xuanhuan-ch200-climb-DONE.md` — xuanhuan Ch200 冻结库事实
- `archive/v7/reports/v7-literary-framework-review.md` — 170 系列杠杆评估与 voice 度量缺陷（200 前置阅读）
