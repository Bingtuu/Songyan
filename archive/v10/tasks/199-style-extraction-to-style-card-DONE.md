...
Task 200 可在本任务 style card 的全局对白观察基础上，单独实现角色声纹锚点。Task 203 可消费 `archive/v10/artifacts/199-style-card-report.json`，但展示时必须保留 report-only 与“观察画像，不是生成约束”的边界说明。
