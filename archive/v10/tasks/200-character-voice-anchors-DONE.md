...
| JSON 报告 | `archive/v10/artifacts/200-character-voice-anchor-report.json` |
| Markdown 报告 | `archive/v10/reports/200-character-voice-anchor-report.md` |
...
Task 201 judge 偏差对策可使用本任务的 unknown 归因比例和角色声纹报告，修正 judge 对“谁说话都一个腔”的宽松偏差。Task 203 可消费 `archive/v10/artifacts/200-character-voice-anchor-report.json`，但展示时必须保留 report-only 与“不是 DialogueStyleCard”的边界说明。
