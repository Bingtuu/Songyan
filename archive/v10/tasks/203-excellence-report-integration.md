...
| 输入 | 路径 | 用途 |
|------|------|------|
| Task 196 sample | `archive/v10/artifacts/196-excellence-sample-set.json` | 样本来源与章节顺序 |
| Task 196 annotations | `archive/v10/artifacts/196-excellence-annotations.json` | 校准真值与 prelabel 对照 |
| Task 197/198 report | `archive/v10/artifacts/197-198-excellence-signals-report.json` | structure / ai_tone 信号 |
| Task 199 report | `archive/v10/artifacts/199-style-card-report.json` | style card |
| Task 200 report | `archive/v10/artifacts/200-character-voice-anchor-report.json` | voice anchors |
| Task 201 report | `archive/v10/artifacts/201-judge-bias-report.json` | judge bias |
| Task 202 report | `archive/v10/artifacts/202-readability-feasibility-report.json` | readability / PPL feasibility |
...
| JSON 报告 | `archive/v10/artifacts/203-excellence-integrated-report.json` |
| Markdown 报告 | `archive/v10/reports/203-excellence-integrated-report.md` |
