...
| Task 204 JSON report | `archive/v10/artifacts/204-kg-diff-spike-report.json` | KG diff 命中、gain matrix、needs_validity_interval |
| Task 204 Markdown report | `archive/v10/reports/204-kg-diff-spike-report.md` | 人读摘要与路由 |
