...
> **执行更新**: Task 121b 已执行 rehearsal，`run-21ff158b` 在 Ch5 阻断，详见 `archive/v5/tasks/121b-ch1-ch150-single-run-rehearsal-DONE.md`。
> **修复更新**: Task 121c 已修复 rewrite fallback 后 settlement 被跳过的直接阻断，详见 `archive/v5/tasks/121c-rewrite-fallback-settlement-contract-DONE.md`。
