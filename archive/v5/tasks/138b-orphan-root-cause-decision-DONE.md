...
- 更新 `archive/v5/tasks/138b-orphan-root-cause-decision-DONE.md`、`archive/v5/tasks/137-setting-recycling-closed-loop.md`、`.trae/specs/complete-v51-remaining-tasks/tasks.md`。
...
- 文档层面: `archive/v5/tasks/138c-orphan-minimal-fix-DONE.md` 与 Task 137 文档记录实际改动、测试结果、风险边界和是否需要 Task 138d。
...
- 更新 `archive/v5/tasks/138b-orphan-root-cause-decision-DONE.md`、`archive/v5/tasks/137-setting-recycling-closed-loop.md`、`.trae/specs/complete-v51-remaining-tasks/tasks.md`、`.trae/specs/complete-v51-remaining-tasks/checklist.md`。
...
- 文档层面:
  - `archive/v5/tasks/138c-orphan-minimal-fix-DONE.md` 与 Task 137 文档记录实际改动、测试结果、风险边界和是否进入 Task 138d-R2。
- 复跑前置:
