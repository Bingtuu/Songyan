...
- [x] 更新 `archive/v5/tasks/137-setting-recycling-closed-loop.md`。
- [x] 更新 `docs/STATUS.md`。
...
- `archive/v5/tasks/137-setting-recycling-closed-loop.md`: 追加 Task 138e 收尾判断，保留 Task 137 活跃。
- `docs/STATUS.md`、`tasks/V5-README.md`、`README.md`、`docs/INDEX.md`: 同步最新事实口径。
- `archive/v5/reports/task-137-ch10-focus-validation-report.md`: 结论更新为 Task 137 不能归档，下一轮 138a。
...
- 下一轮入口：保持 `archive/v5/tasks/137-setting-recycling-closed-loop.md` 活跃，不创建 `tasks/137-setting-recycling-closed-loop-DONE.md`；下一轮从 Task 138a 开始，对 `run-4fd48756` 的 16 个 orphan 重新分类，不启动 Ch1-Ch20/default run。
