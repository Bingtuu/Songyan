...
> **完成日期**: 2026-07-01
> **规划/设计**: `docs/v6-plan.md` §1.4；任务书 `archive/v6/tasks/148z-stage-a-threshold-calibration.md`

---

## 交付概览

用 Task 145-148 的度量模块对历史库（138n/138k）复算实际分布，校准并冻结 v6-plan §1.4 全部 ⚙ 阈值，产出 `archive/v6/reports/v6-stageA-threshold-calibration.md`，并回写 v6-plan §1.4。

| 交付物 | 文件 |
|--------|------|
| 标定报告 | `archive/v6/reports/v6-stageA-threshold-calibration.md` |
