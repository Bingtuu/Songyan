...
- [ ] 生成 `archive/v6/tasks/151-mr-adaptive-cap-and-relevance-DONE.md`，含自适应公式来源、排序规则、MR 封顶口径澄清（区分 MR 装配上限 vs `MAX_ORPHANED=12`）、Ch100 命中率对比。
...
- 138m 根因报告（MR 上限/过载分析）：`archive/v5/reports/task-138m-critical-orphan-root-cause-report.md`
