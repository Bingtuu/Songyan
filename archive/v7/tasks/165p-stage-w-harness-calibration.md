...
> **事实入口**: `tasks/V7-README.md`；报告：`archive/v7/reports/task-165-stage-w-exit-report.md`

> **执行结果**: 已完成，见 `archive/v7/tasks/165p-stage-w-harness-calibration-DONE.md`。复算后阶段 W 通过，T9/T10 已冻结。
...
- [ ] 核对 `archive/v7/reports/task-165-stage-w-exit-report.md`：
  - P 洁净 pass
  - L 文学 pass
  - 修复对比 pass
  - 不回退 pass 或给出新的真实阻断项
...
- `archive/v7/reports/task-165-v7-threshold-calibration.md`
- `archive/v6/reports/task-159-v6-final-acceptance-report.md`
- `archive/v6/reports/task-157-ch1-ch50-integration-validation-report.md`
- `archive/v6/reports/task-158-ch1-ch100-long-run-validation-report.md`
- `archive/v6/tasks/148z-stage-a-threshold-calibration-DONE.md`
- `archive/v6/tasks/156-in-run-db-maintenance-DONE.md`
