...
> **执行结果**: 已完成，见 `archive/v7/tasks/166-plan-generate-replan-loop-DONE.md`。
...
- 生成 `archive/v7/tasks/166-plan-generate-replan-loop-DONE.md` 前，必须有可重复的离线 evidence。

## 参考文档

- `archive/v7/tasks/166a-arc-outcome-evaluation-and-replan-proposal.md`
- `archive/v7/tasks/166b-approved-replan-application.md`
- `archive/v7/tasks/165-stage-w-ch150-rerun-and-threshold-freeze-DONE.md`
