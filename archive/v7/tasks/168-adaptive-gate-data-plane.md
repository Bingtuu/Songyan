...
- [x] 目标测试和相关回归通过。
- [x] 生成 `archive/v7/tasks/168-adaptive-gate-data-plane-DONE.md`。
...
- `archive/v6/tasks/145-orphan-and-critical-rate-metrics-DONE.md`
- `archive/v6/tasks/146-quality-debt-ledger-DONE.md`
- `archive/v6/tasks/147-literary-quality-trend-DONE.md`
- `archive/v6/tasks/148-arc-foreshadowing-fulfillment-DONE.md`
- `archive/v7/tasks/165p-stage-w-harness-calibration-DONE.md`
- `archive/v7/tasks/167-long-range-foreshadowing-active-scheduling-DONE.md`
