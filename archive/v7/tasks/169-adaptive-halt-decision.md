...
- [x] 生成 `archive/v7/tasks/169-adaptive-halt-decision-DONE.md`。
...
- `archive/v7/tasks/168-adaptive-gate-data-plane-DONE.md`
- `archive/v7/tasks/168a-adaptive-gate-signal-snapshot-DONE.md`
- `archive/v7/tasks/168b-adaptive-gate-window-reporting-DONE.md`
