...
- 爬坡 harness 固定写入：
  ...
  - 报告：`archive/v9/reports/187-urban-ch100-climb.md`
...
- Task 187 执行记录单独落到 `archive/v9/187-urban-ch100-climb-execution.md`，完成后改为 `*-DONE.md`。
...
- 185 前置证据：`archive/v9/185-urban-short-window-calibration-DONE.md`
