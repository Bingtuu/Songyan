...
| `tasks/V10-README.md` | **V10 规划入口（V10.2 Task 193 wuxia Ch200 climb 人工暂停）**：跨体裁 Ch200 + 优秀度信号包 + 结构升级 spike；本文不占任务号；Task 189/190/191/192 已完成，Task 193 已到 Ch120 accepted，当前按用户要求暂停于 Ch121 under_review，下一步 Ch121→Ch125 |
...
| 场景 | 文件 |
|------|------|
| V10 规划入口（V10.2 Task 193 wuxia Ch200 climb 人工暂停） | `tasks/V10-README.md` |
