...
| `tasks/V10-README.md` | **V10 规划入口（V10.2 Task 192.ae blocker 待修复）**：跨体裁 Ch200 + 优秀度信号包 + 结构升级 spike；本文不占任务号；Task 189/190/191/192.p/q/r/s/t/u/v/w/x/y/z/aa/ab/ac/ad 已完成，xuanhuan Ch200 target 到 Ch120 后触发 health_low_p1_halt，修复前不得继续 Ch121/125 |
...
| 场景 | 文件 |
|------|------|
| V10 规划入口（V10.2 Task 192.ae blocker 待修复） | `tasks/V10-README.md` |
