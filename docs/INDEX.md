...
| `tasks/V10-README.md` | **V10 规划入口（V10.2 Task 193 wuxia Ch200 climb 进行中）**：跨体裁 Ch200 + 优秀度信号包 + 结构升级 spike；本文不占任务号；Task 189/190/191/192 已完成，Task 193 已到 Ch150 accepted，Ch150 段边界审计 five-gate/segment/T9 全 PASS，下一步 Ch151→Ch175 |
...
| 场景 | 文件 |
|------|------|
| V10 规划入口（V10.2 Task 193 wuxia Ch200 climb 进行中，已到 Ch150 accepted） | `tasks/V10-README.md` |
