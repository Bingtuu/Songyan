...
| `tasks/V10-README.md` | **V10 规划入口（V10.2 Task 192 主线恢复中）**：跨体裁 Ch200 + 优秀度信号包 + 结构升级 spike；本文不占任务号；Task 189/190/191/192.p 已完成，Task 192/193/194 任务书已建立，尚未启动非 sci-fi Ch200 长跑 |
...
| V10.2 Ch200 爬坡任务书与前置修复 | `tasks/192-xuanhuan-ch200-climb.md`、`tasks/192.p-scifi-short-regression-context-emergency-DONE.md`、`tasks/193-wuxia-ch200-climb.md`、`tasks/194-urban-ch200-climb.md` |
