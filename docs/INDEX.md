...
| `tasks/V10-README.md` | **V10 规划入口（V10.2 Task 192.af xuanhuan Ch129 settlement blocker）**：跨体裁 Ch200 + 优秀度信号包 + 结构升级 spike；本文不占任务号；Task 189/190/191/192.p/q/r/s/t/u/v/w/x/y/z/aa/ab/ac/ad/ae 已完成，xuanhuan Ch125 checkpoint PASS；Ch129 SettlementExtractor JSON parse failure 已冻结，修复前不得继续 Ch130/150 |
...
| 场景 | 文件 |
|------|------|
| V10 规划入口（V10.2 Task 192.af xuanhuan Ch129 settlement blocker） | `tasks/V10-README.md` |
