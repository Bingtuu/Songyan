...
| `tasks/V10-README.md` | **V10 规划入口（V10.2 Task 192 clean Ch100 rebuild Ch50 T9 blocker）**：跨体裁 Ch200 + 优秀度信号包 + 结构升级 spike；本文不占任务号；Task 189/190/191/192.p/q/r 已完成，xuanhuan clean rebuild 到 Ch50 但 T9 duplicate=1，Task 192.s 待修，尚未启动非 sci-fi Ch200 长跑 |
...
| `tasks/192.s-xuanhuan-ch50-t9-duplicate-clean.md` | Task 192.s 任务书：xuanhuan Ch50 T9 duplicate blocker 修复 |
| `docs/reports/192-xuanhuan-ch100-climb.md` | Task 192 执行报告：xuanhuan clean Ch100 rebuild 阶段报告（当前 Ch50 T9 blocker） |
...
| 场景 | 文件 |
|------|------|
| V10 规划入口（V10.2 Task 192 clean Ch100 rebuild Ch50 T9 blocker） | `tasks/V10-README.md` |
