...
| `tasks/V10-README.md` | **V10 规划入口（V10.2 Task 192 xuanhuan Ch109→Ch125 待推进）**：跨体裁 Ch200 + 优秀度信号包 + 结构升级 spike；本文不占任务号；Task 189/190/191/192.p/q/r/s/t/u/v/w/x/y/z/aa/ab/ac 已完成，xuanhuan Ch200 target 到 Ch108 accepted 后 segment audit/T9 PASS，下一步继续 Ch109→Ch125 |
...
| 场景 | 文件 |
|------|------|
| V10 规划入口（V10.2 Task 192 xuanhuan Ch109→Ch125 待推进） | `tasks/V10-README.md` |
