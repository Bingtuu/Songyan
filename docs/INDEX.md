...
| `tasks/V10-README.md` | **V10 规划入口（V10.2 Task 192 clean Ch100 rebuild 中）**：跨体裁 Ch200 + 优秀度信号包 + 结构升级 spike；本文不占任务号；Task 189/190/191/192.p/q/r 已完成，xuanhuan clean rebuild 到 Ch25，尚未启动非 sci-fi Ch200 长跑 |
...
| `docs/reports/192-xuanhuan-ch100-climb.md` | Task 192 执行报告：xuanhuan clean Ch100 rebuild 阶段报告（当前 Ch25） |
