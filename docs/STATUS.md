...
| V8 当前主线 | **Task 172c 进行中**：wuxia Ch75 已达成，但 overdue 暴涨暴露伏笔 resolve 机制失效 + continuity health 漏计 archived overdue 两个设计缺陷 |
...
3. **172c 进行中**：wuxia 段 3 Ch75 已完成，但暴露两个设计缺陷——**SettlementExtractor 伏笔 resolve 机制完全失效**（wuxia/xuanhuan 均为 0 resolved）、**continuity_auditor health 漏计 archived overdue**。下一步立项 **172c.r** 系统修复，修复后再决定 172c 是否继续向 Ch100 推进。
...
- Task 172c.r wuxia 伏笔回收与 continuity 健康度修复：待立项
