...
1. **Task 192 xuanhuan clean Ch100 rebuild（下一步，按编号推进）**：192.t 已完成，Ch75 复判 segment audit PASS；继续从 Ch76 推进到 Ch100，边界必须复跑 accepted/T9/five-gate/segment audit/profile/source inventory，全部通过后再用 Task 191 harness 初始化 Ch200。
