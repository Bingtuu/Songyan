...
| 指标 | 数值 |
|------|------|
| 状态 | **V5.0 Phase 4 — Task 111f 已完成，进入 Task 111g 长跑性能缺陷收敛** |
...
| 最近回归测试 | **1649 passed, 4 skipped, 2 xfailed, 3 xpassed** (`python -m pytest tests/ -q`, Task 111f) |
| Python | 3.11.9 |
| 当前 Task | **Task 111g: 长跑性能缺陷收敛** |
