...
| 项 | 结论 |
|----|------|
| 当前阶段 | **V9 已开工**：生产化地基 + urban 第三体裁 Ch100，Task 173-188 扁平编号，事实入口 `tasks/V9-README.md`。**V9.1 长跑可靠性全部完成**（173/174/175/176 ✅）；**V9.2 Task 177/178 ✅ 完成**：`songyan export` 已能从 accepted head 导出 flat/arc/volume Markdown/txt 纯净书稿；wheel 打包与资源加载已修复并通过非仓库 cwd 验收；下一步 Task 179 CLI 三坑 |
...
1. **V9.2 交付与发布（179-181）**：177 export 与 178 wheel 打包/资源加载已完成；下一步 Task 179 CLI 三坑，然后推进 180 doctor、181 CI，详见 `tasks/V9-README.md`。
