...
> source_manifest: `tasks/204-kg-diff-sample-manifest.json`
> source_kg_diff_report: `tasks/204-kg-diff-spike-report.json`
> source_facttrack_report: `tasks/205-facttrack-validity-interval-report.json`
