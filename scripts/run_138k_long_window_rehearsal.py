"""Task 138k: 长窗口 rehearsal Ch1-Ch30/50/100.

用法:
    # 1. 先把主库复制到 .tmp
    Copy-Item "songyan.db" ".tmp/task138k_ch1_ch30_rehearsal_20260629.db"
...
说明:
    ...
    - 生成 docs/reports/task-138k-long-window-rehearsal-report.md。
"""
...
REPORT_PATH = Path("docs/reports/task-138k-long-window-rehearsal-report.md")
METRICS_PATH = Path(".tmp/task138k_per_chapter_metrics.jsonl")
