...
class GenreRuntimeProfile(BaseModel):
    ...
    # 伏笔埋设 horizon 下限（172a.p/172b.p：S/V 维度定点修复） ---
    ...
    # 模拟（xuanhuan uco3ialu 短窗口 DB）：floor=10 -> overdue 6；floor=12 -> overdue 1。
    # 172b.p Ch65 长窗口实跑证明 xuanhuan plant 密度更高，Ch100 口径需 floor=48。
