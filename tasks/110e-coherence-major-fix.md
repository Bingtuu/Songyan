...
- Ch101-Ch150 验证（现顺延为 Task 112）即将启动，若 coherence_major 不解决，后半程达标率将进一步恶化
...
- 在 110e 修复后，先修复整体 review 暴露的 Agent/Workflow 一致性问题
- Task 111a-111c 完成后，再进入 Task 112: Ch101-Ch150 流式验证 + 决策门 DG-2
- Task 112 仍以达标率 >= 70%、budget_used <= 1.0 为主要决策门
