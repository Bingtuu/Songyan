...
- 报告：`docs/reports/task-138k-long-window-rehearsal-report.md`
...
- 阻塞：`tasks/138k-long-window-rehearsal-ch1-ch50.md`
- 相关已完成：`tasks/138f-settlement-evidence-gated-numerical-extraction-DONE.md`
