...
> **状态**: ✅ 完成
> **完成日期**: 2026-07-02
> **关联文档**: `tasks/149-input-side-demotion.md`、`tasks/V6-README.md`、`docs/STATUS.md`
...
| `tasks/149-input-side-demotion-DONE.md` | 本文件 |
...
- `critical_cap = 3`（首版）。
- 依据：`tasks/149-input-side-demotion.md` 阈值初版规定；后续在 Layer 3 用 138k/138n 数据校准，若复算发现被降级 critical 占同窗口新增 critical 总数超过 15%（T6c 子句），再上调 cap 或回调产生侧约束。
