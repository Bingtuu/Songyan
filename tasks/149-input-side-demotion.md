...
- [ ] 生成 `tasks/149-input-side-demotion-DONE.md`，含超额阈值来源、T7 与候选口径决定、Layer 3 归因证据。
...
- 阶段 A 冻结口径：`tasks/148z-stage-a-threshold-calibration-DONE.md`、`docs/reports/v6-stageA-threshold-calibration.md`
