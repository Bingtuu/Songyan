...
- [ ] 生成 `tasks/156-in-run-db-maintenance-DONE.md`，含维护动作分级与选型理由、遥测口径、章节边界执行的并发安全说明、小窗口趋势与 T5 待测标注。
...
- T5 标定延后依据：`docs/reports/v6-stageA-threshold-calibration.md:48-49`
