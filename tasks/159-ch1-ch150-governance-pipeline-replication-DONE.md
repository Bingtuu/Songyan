...
> **完成日期**: 2026-07-04
> **规划文档**: `tasks/159-ch1-ch150-governance-pipeline-replication.md`
> **验收报告**: `docs/reports/task-159-v6-final-acceptance-report.md`
...
| V6 阶段验收报告 | `docs/reports/task-159-v6-final-acceptance-report.md` |
...
- `tasks/157-ch1-ch50-integration-validation-DONE.md`、`tasks/158-ch1-ch100-long-run-validation-DONE.md`
- kill→resume 命令级证据：`docs/reports/task-158r-kill-resume-drill-report.md`
- 阈值标定：`tasks/148z-stage-a-threshold-calibration-DONE.md`
