...
- [ ] 生成 `tasks/161-paragraph-dedup-DONE.md`（含去重规则、阈值标定依据、检测器接口、Ch75/19 章样本命中率）。
...
- 缺陷证据：`docs/reports/task-159-v6-final-acceptance-report.md` + `run-bba292da` 正文质量评估（Ch75 最重）
