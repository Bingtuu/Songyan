...
- `python -m pytest tests/test_177_export_service.py -q` → **13 passed**。
- `powershell -NoProfile -File scripts\run_with_timeout.ps1 -TimeoutSec 1200 -DetectPytestSummary -- python -m pytest tests/ -q` → **2895 passed, 2 skipped, 1 xfailed, 7 warnings**；`WRAPPER_RESULT=PASS_NORMAL_EXIT`。
