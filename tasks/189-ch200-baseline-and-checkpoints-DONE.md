...
| `tasks/189-scifi-ch200-baseline.json` | 受版本管理的 canonical baseline，适用范围 Ch125-Ch200 |
...
```powershell
python scripts/five_gate_check.py --genre scifi --db .tmp/task171_ch1_ch200.db --project-id 835afdf11a294b5eac74a5d8998bd9a2 --up-to 125 --baseline tasks/189-scifi-ch200-baseline.json --format json
python scripts/five_gate_check.py --genre scifi --db .tmp/task171_ch1_ch200.db --project-id 835afdf11a294b5eac74a5d8998bd9a2 --up-to 150 --baseline tasks/189-scifi-ch200-baseline.json --format json
python scripts/five_gate_check.py --genre scifi --db .tmp/task171_ch1_ch200.db --project-id 835afdf11a294b5eac74a5d8998bd9a2 --up-to 175 --baseline tasks/189-scifi-ch200-baseline.json --format json
python scripts/five_gate_check.py --genre scifi --db .tmp/task171_ch1_ch200.db --project-id 835afdf11a294b5eac74a5d8998bd9a2 --up-to 200 --baseline tasks/189-scifi-ch200-baseline.json --format json
```
...
```powershell
Copy-Item tasks/189-scifi-ch200-baseline.json .tmp/189_scifi_ch200_baseline.json
```
