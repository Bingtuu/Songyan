...
Ch125/150/175/200 five-gate 均显式绑定 `tasks/189-scifi-ch200-baseline.json`。
...
```powershell
python scripts/run_v10_ch200_climb.py --audit --genre urban --up-to 200 --baseline tasks/189-scifi-ch200-baseline.json --format json
```
