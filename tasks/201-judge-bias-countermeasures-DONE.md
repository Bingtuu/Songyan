...
| JSON 报告 | `tasks/201-judge-bias-report.json` |
| Markdown 报告 | `docs/reports/201-judge-bias-report.md` |
...
Task 202 可进入 perplexity / 可读性可行性 spike。Task 203 可消费 `tasks/201-judge-bias-report.json`，但展示时必须保留 report-only 与“对策协议，不是已上线 judge 改善”的边界说明。
