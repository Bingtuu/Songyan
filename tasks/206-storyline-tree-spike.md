...
| Task 204 report | `tasks/204-kg-diff-spike-report.json` | KG diff 命中与 needs_validity_interval |
| Task 205 report | `tasks/205-facttrack-validity-interval-report.json` | validity interval 解释结果与 needs_storyline_tree |
...
| JSON 报告 | `tasks/206-storyline-tree-spike-report.json` |
| Markdown 报告 | `docs/reports/206-storyline-tree-spike-report.md` |
