...
| Task | 名称 | 状态 | 内容要点 | 验收要点 |
|------|------|:----:|----------|----------|
| 192 | xuanhuan Ch200 爬坡 | ◐ | clean Ch100 source ready；Task 191 harness 已初始化 Ch200 target；Ch125 checkpoint PASS；Ch129 settlement/summary 与 segment audit 已由 192.af/ag 修复；Ch131 已由 192.ah 修复；Ch134 已由 192.ai 修复；Ch138 已由 192.aj 修复；Ch144 已由 192.ak 修复；Ch150 direct P1 已由 192.al 修复；post-fix segment/five-gate blocker 路由 192.am，修复前不得继续 Ch151 | 任务书：`tasks/192-xuanhuan-ch200-climb.md`；执行报告：`docs/reports/192-xuanhuan-ch100-climb.md` |
...
| 192.am | xuanhuan Ch150 segment audit critical orphans | ◐ | post-fix segment audit @150 FAIL：`critical_orphans=3`、`halt_would_fire=true`；five-gate health FAIL（7.3 < 8.0）；修复前不得继续 Ch151/175 | 任务书：`tasks/192.am-xuanhuan-ch150-segment-audit-critical-orphans.md` |
