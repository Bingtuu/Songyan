...
| Task | 名称 | 状态 | 内容要点 | 验收要点 |
|------|------|:----:|----------|----------|
| 192 | xuanhuan Ch200 爬坡 | ◐ | clean Ch100 source ready；Task 191 harness 已初始化 Ch200 target；Ch125 checkpoint PASS；Ch129 settlement/summary 与 segment audit 已由 192.af/ag 修复；Ch131 已由 192.ah 修复；Ch134 已由 192.ai 修复；Ch138 已由 192.aj 修复；Ch144 已由 192.ak 修复；Ch150 direct P1 已由 192.al 修复；segment critical orphans 已由 192.am 修复；five-gate stale health blocker 路由 192.an，修复前不得继续 Ch151 | 任务书：`tasks/192-xuanhuan-ch200-climb.md`；执行报告：`docs/reports/192-xuanhuan-ch100-climb.md` |
...
| 192.an | xuanhuan Ch150 five-gate health stale report | ◐ | 同章旧 continuity report 导致 five-gate health_latest 读到 stale 7.3；需修复 latest report 排序并复验 Ch150 gates；修复前不得继续 Ch151/175 | 任务书：`tasks/192.an-xuanhuan-ch150-five-gate-health-stale-report.md` |
