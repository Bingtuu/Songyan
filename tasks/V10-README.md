...
| Task | 名称 | 状态 | 内容要点 | 验收要点 |
|------|------|:----:|----------|----------|
| 192 | xuanhuan Ch200 爬坡 | ◐ | clean Ch100 source ready；Task 191 harness 已初始化 Ch200 target；Ch125 checkpoint PASS；Ch150 checkpoint PASS；Ch156 clean；Ch162 `health_low_p1_halt` 已冻结为 192.ap；修复前不得继续 Ch163/175 | 任务书：`tasks/192-xuanhuan-ch200-climb.md`；执行报告：`docs/reports/192-xuanhuan-ch100-climb.md` |
...
| 192.ap | xuanhuan Ch162 health_low_p1_halt | ◐ | Ch157-Ch162 accepted；Ch162 continuity audit health=8.6，P1 target `xuanhuan_lingyuan_seal.self.as_door`；run paused、failed=[] | 任务书：`tasks/192.ap-xuanhuan-ch162-health-low-p1-halt.md` |
