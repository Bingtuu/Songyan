...
| Task | 名称 | 状态 | 内容要点 | 验收要点 |
|------|------|:----:|----------|----------|
| 192 | xuanhuan Ch200 爬坡 | ◐ | clean Ch100 source ready；Task 191 harness 已初始化 Ch200 target；Ch125 checkpoint PASS；Ch129 settlement/summary 与 segment audit 已由 192.af/ag 修复；Ch131 已由 192.ah 修复；Ch134 已由 192.ai 修复；Ch138 已由 192.aj 修复；Ch144 已由 192.ak 修复；Ch150 accepted 后触发 192.al P1 hard gate，修复前不得审计 Ch150 或继续 Ch151 | 任务书：`tasks/192-xuanhuan-ch200-climb.md`；执行报告：`docs/reports/192-xuanhuan-ch100-climb.md` |
...
| 192.al | xuanhuan Ch150 health_low_p1_halt repair | ◐ | Ch145-Ch150 accepted 后 auto halt：`health_low_p1_halt: P1_count=1`；P1 target `xuanhuan_lingyuan.technique.lingyuan_quan_first_form`；run paused、completed 1..150、failed=[]；修复前不得执行 Ch150 audit 或继续 Ch151/175 | 任务书：`tasks/192.al-xuanhuan-ch150-health-low-p1-halt.md` |
