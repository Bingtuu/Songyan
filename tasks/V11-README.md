...
> **状态**: 已启动；Task 208 readiness audit、Task 209 Quickstart 文档闭环、Task 210 doctor / preflight 增强、Task 211 backup / restore / schema ledger 已完成，下一步进入 Task 212 失败恢复体验。
...
Task 209 留给后续实现的 runtime 缺口中，非法 `CHECKPOINTER_MODE` traceback 与 `run` 业务失败 exit code 语义已由 Task 210 收口；backup/restore 已由 Task 211 收口。
