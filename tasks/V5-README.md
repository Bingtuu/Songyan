...
> **当前口径**: **V5.0 完成** — Task 115-120 全部收口，P0/P1 风险为 0；Task 121b single-run rehearsal 已执行但未通过
> **最后整理**: 2026-06-21
...
| Ch1-Ch150 single-run rehearsal | `run-21ff158b`：Ch1-Ch4 成功，Ch5 `settlement_review` 阻断，最终 `partial` |
| 最近全量回归 | `1718 passed, 2 xfailed, 14 warnings` |
...
| 一次性 Ch1-Ch150 单命令证据 | P1 | **Task 121b 已执行但未通过**：Ch5 rewrite 结构完整性失败后 `skip_settlement=True`，需先修复再重跑 |
